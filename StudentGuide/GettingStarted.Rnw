...
\FoodForThought{Registered students at Amherst College can connect to \url{r.amherst.edu}, while
Smith College students connect to \url{rstudio.smith.edu:8787}.
Other servers have been installed at many other institutions.
