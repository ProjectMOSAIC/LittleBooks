...
<<include=FALSE>>=
#setCacheDir("cache")
# require(MASS)   # commented out by NJH 9/27/2015
require(grDevices) 
require(datasets) 
require(stats) 
require(lattice)
...
\parbox{4in}{\noindent Copyright (c) 2018 by Nicholas J. Horton, Randall Pruim, \& Daniel Kaplan.}
\medskip

\parbox{4in}{\noindent Edition 1.3, June 2018}
