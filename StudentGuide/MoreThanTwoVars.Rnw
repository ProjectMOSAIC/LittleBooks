...
display the predicted CESD values for a range of MCS (mental component score) values a hypothethical 36 year old male and female subject might have from the parallel
