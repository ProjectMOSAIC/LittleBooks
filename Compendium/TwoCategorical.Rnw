...
relative to the low data to ink ratio.\cite{Tufte:2001:Visual}  But we have found them to be helpful to reinforce understanding of a two way contingency table.}%
